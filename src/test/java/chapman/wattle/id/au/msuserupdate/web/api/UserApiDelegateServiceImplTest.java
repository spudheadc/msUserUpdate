...
class UserApiDelegateServiceImplTest {
  ...
  public void testAddUserSuccess() {
    ...
    User user = new User();
    user.orgId(TestConstants.ORG_ID)
  ...
  public void testDeleteUserSuccess() {
    ...
    doNothing().when(userService).deleteUser(TestConstants.USER_ID, Constants.NO_REASON_SUPPLIED);

    UserApiDelegateServiceImpl delegate = new UserApiDelegateServiceImpl(userService);

    ResponseEntity<Void> entity = delegate.deleteUser(TestConstants.USER_ID);
    assertEquals(HttpStatus.NO_CONTENT, entity.getStatusCode());
  }
}
