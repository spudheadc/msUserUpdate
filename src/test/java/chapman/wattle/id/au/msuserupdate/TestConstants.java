...
public class TestConstants {
    ...
    public static UserModify TEST_USER_PHONE_DTO =
        (new UserPhoneModify()).phone(TestConstants.TEST_PHONE_2).updateType(UpdateTypeEnum.USERPHONE);
    public static UserModify TEST_USER_EMAIL_DTO =
        (new UserEmailModify()).email(TestConstants.TEST_EMAIL_2).updateType(UpdateTypeEnum.USEREMAIL);
    public static UserModify TEST_USER_NAME_DTO =
        (new UserNameModify()).firstName(TestConstants.TEST_FIRST).lastName(TestConstants.TEST_LAST_2).updateType(UpdateTypeEnum.USERNAME);
    ...
    public static final Document CREATED_ENTITY_DOCUMENT =
        (new Document("_id", new ObjectId())).append("userId", USER_ID.toString())
